...
export default function AgentCalendarPage() {
  return (
    <DashboardShell title="Asesor" nav={NAV}>
      <h1 className="mb-5 text-xl font-semibold tracking-tight">Agenda</h1>
      <DashboardComingSoon
        title="Agenda de visitas"
        description="Programa y da seguimiento a tus visitas desde un calendario integrado con tus leads."
      />
    </DashboardShell>
  );
}
