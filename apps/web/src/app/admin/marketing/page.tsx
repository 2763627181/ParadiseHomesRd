...
export default function AdminMarketingPage() {
  return (
    <DashboardShell title="Admin" nav={NAV}>
      <h1 className="mb-6 text-xl font-semibold tracking-tight">Marketing</h1>
      <DashboardComingSoon
        title="Marketing y campañas"
        description="Gestión de campañas UTM, banners destacados y promociones. Por ahora la atribución UTM ya se captura por lead (ver Leads → fuente)."
      />
    </DashboardShell>
  );
}
